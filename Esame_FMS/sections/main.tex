    ...
    \begin{columns}[T] % L'opzione [T] allinea i blocchi in alto
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Other Backgrounds}
                \small
                \begin{itemize}
                    \item \textbf{Prompt Leptons:} $ZZ$, $WW$, $VVV$, $t\bar{t}V$, $tZj$. Estimated via MC simulations.
            ...
            \begin{block}{Detector Simulation}
                \small
                All MC samples processed through \texttt{Geant4} ATLAS detector simulation and standard reconstruction software.
            \end{block}
        \end{column}
...
\begin{frame}{Physics Objects: Jets \& $E_{\mathrm{T}}^{\mathrm{miss}}$}
    ...
    Pile-up suppression (JVT):\textit{tight} ($p_T < 60\,\mathrm{GeV}, |\eta| < 2.4$) and \newline \textit{loose} ($p_T < 120\,\mathrm{GeV}, 2.5 < |\eta| < 4.5$) \\
    \hline
    ...
    \begin{columns}[T] 
        ...
        \begin{column}{0.52\textwidth}
            ...
            \begin{tcolorbox}[colframe=red!70!black, colback=red!5, boxrule=1pt, arc=4pt, 
                              ...
                              title=\textbf{VBS (EW Production)}]
                \centering \small % Centro il testo e lo rimpicciolisco leggermente
                $\sigma_{\text{obs}}^{\text{EW}} = 0.368 \pm 0.037_{\text{stat}} \pm 0.059_{\text{syst}}\,\unit{fb}$ \\[0.15cm]
